...
<div class="container">
    ...
    {% if recommendations %}
      ...
      <div class="problem-card">
        ...
        <table class="rec-table">
          <thead>
            <tr>
              <th>建議產品</th><th>類別</th><th>建議劑量</th>
              <th>注射層次</th><th>注射方式</th><th>預估效果</th>
            </tr>
          </thead>
          <tbody>
      ...
      {% endfor %}
    {% else %}
      <p style="color:#7090a0;">目前未偵測到需要治療的明顯問題。</p>
    {% endif %}
  </div>
  <div class="section">
  ...
  <div class="disclaimer">
    ⚠️ <strong>免責聲明</strong>：本系統為輔助參考工具，分析結果基於 AI 演算法，存在一定誤差。
